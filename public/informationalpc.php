<section class="FirstInfoPart">
    <div class="container">
        <div class="FirstInfoContent">
            <h1 class="MainHeadText">Ремонт комп'ютерів</h1>
            <div class="WrapDiv">
                <div class="InfoButtonCont">
                    <img class="InfoBG" src="img/informationalpc/monoblok.png" alt="PCBackground">
                    <a href="#">
                ...
                <div class="InfoIntro">
                    <div class="InfoIntroText">
                        ...
                        <p class="SimpleInfoText">від 500 до 4000 грн;</p>
        ...
        <div class="SecondInfoContent">
            <div class="SecondInfoBox">
                <div class="SecondInfoTextBox">
                    <p class="InfoOrangeText">Не працює комп'ютер?</p>
                    <p class="InfoSimpleText">
                        Ми здійснюємо ремонт комп'ютерів будь-якої
                        марки і року випуску: ПК, моноблоки
                        і т.д. Везти комп'ютер до сервісного центру
                        ...
                        комп'ютер, вам треба лише подати нам заявку на
            ...
            <div class="SecondInfoBox">
                <div class="SecondInfoTextBox">
                    ...
                    <p class="InfoSimpleText">
                        ...
                        для ремонту комп'ютера, ви можете бути впевнені,
    ...
    <div class="container">
        ...
        <div class="ThirdInfoContent">
            <div class=ThirdInfoColumn>
                <div class="InfoIntro">
                    <div class="InfoIntroText">
                        <p class="SimpleInfoText">Заміна кабелів - від 430 грн.</p>
                        <p class="SimpleInfoText">Заміна корпусу - від 430 грн.</p>
                        <p class="SimpleInfoText">Ремонт сисітемних плат - від 500 грн.</p>
                        <p class="SimpleInfoText">Ремонт системи підсвічування - від 380 грн.</p>
                        <p class="SimpleInfoText">Заміна кнопок - від 120 грн.</p>
                        <p class="SimpleInfoText">Ремонт екранів - від 450 грн.</p>
                        <p class="SimpleInfoText">Ремонт блоків живлення - від 320 грн.</p>
                        <p class="SimpleInfoText">Заміна роздулися конденсаторів - від 200 грн.</p>
                        <p class="SimpleInfoText">Заміна процесора - від 430 грн.</p>
                        <p class="SimpleInfoText">Заміна відеокарти - від 500 грн.</p>
                        <p class="SimpleInfoText">Заміна згорілих елементів від 100 грн.</p>
                        <p class="SimpleInfoText">Заміна шлейфів - від 350 грн.</p>
                        <p class="SimpleInfoText"> Ремонт/установка нових кулерів - від 400 грн.</p>
                    </div>
                </div>
                <div class="InfoIntroText">
            ...
            <div class=ThirdInfoColumn>
                <img class="FirstInfoImg" src="img/informationalpc/pcrepair1.png" alt="FirstImage">
                <img class="SecondInfoImg" src="img/informationalpc/pcrepair2.png" alt="SecondImage">
            </div>
        </div>
    </div>
</section>