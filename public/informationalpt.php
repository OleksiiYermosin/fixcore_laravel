<section class="FirstInfoPart">
    <div class="container">
        <div class="FirstInfoContent">
            <h1 class="MainHeadText">Ремонт гаджетів</h1>
            <div class="WrapDiv">
                <div class="InfoButtonCont">
                    <img class="InfoBG" src="img/informationalpt/imgPT.jpg" alt="TVBackground">
                    <a href="#">
    ...
    <div class="container">
        ...
        <div class="ThirdInfoContent">
            <div class=ThirdInfoColumn>
                <div class="InfoIntro">
                    <div class="InfoIntroText">
                        <p class="SimpleInfoText">Відновлення акумуляторів методом тривалого заряду малими струмами - 250 грн.</p>
                        <p class="SimpleInfoText">Заміна АКБ в смартфоні шляхом демонитажу дисплейного модуля - 700 грн.</p>
                        <p class="SimpleInfoText">Заміна динаміка смартфона - 350 грн.</p>
                        <p class="SimpleInfoText">Заміна дисплея (екрана, LCD/LED матриці) - 350-900 грн.</p>
                        <p class="SimpleInfoText">Заміна екранного модуля (тачскрін + LCD/LED) - 350 грн.</p>
                        <p class="SimpleInfoText">Заміна камери смартфона - 350 грн.</p>
                        <p class="SimpleInfoText">Заміна корпуса смартфона - 300 грн.</p>
                        <p class="SimpleInfoText">Заміна мікрофона смартфона - 350 грн. + віртість запчастин</p>
                        <p class="SimpleInfoText">Перезбірка смарфтону - 300 грн.</p>
                    </div>
                </div>
                <div class="InfoIntroText">
            ...
            <div class=ThirdInfoColumn>
                <img class="FirstInfoImg" src="img/informationalpt/rep1.jpg" alt="FirstImage">
                <img class="SecondInfoImg" src="img/informationalpt/rep2.jpg" alt="SecondImage">
            </div>
        </div>
    </div>
</section>