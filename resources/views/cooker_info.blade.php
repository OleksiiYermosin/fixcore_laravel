    ...
    <section class="FirstInfoPart">
        <div class="container">
            <div class="FirstInfoContent">
                <h1 class="MainHeadText">Ремонт електроплит</h1>
                <div class="WrapDiv">
                    <div class="InfoButtonCont">
                        <img class="InfoBG" src="img/informationalcooker/plitabg.png" alt="CookerBackground">
                        <a href="#">
                    ...
                    <div class="InfoIntro">
                        <div class="InfoIntroText">
                            ...
                            <p class="SimpleInfoText">від 500 до 5000 грн;</p>
            ...
            <div class="SecondInfoContent">
                <div class="SecondInfoBox">
                    <div class="SecondInfoTextBox">
                        <p class="InfoOrangeText">Не працює електроплита?</p>
                        <p class="InfoSimpleText">
                            Ми здійснюємо ремонт електроплит будь-якої
                            марки і року випуску: індуктивні, керамічні
                            і т.д. Везти плиту до сервісного центру
                            ...
                            плиту, вам треба лише подати нам заявку на
                ...
                <div class="SecondInfoBox">
                    <div class="SecondInfoTextBox">
                        ...
                        <p class="InfoSimpleText">
                            ...
                            для ремонту електроплити, ви можете бути впевнені,
        ...
        <div class="container">
            ...
            <div class="ThirdInfoContent">
                <div class=ThirdInfoColumn>
                    <div class="InfoIntro">
                        <div class="InfoIntroText">
                            <p class="SimpleInfoText">Заміна кілець - від 430 грн.</p>
                            <p class="SimpleInfoText">Заміна шлангів - від 430 грн.</p>
                            <p class="SimpleInfoText">Ремонт індуктивних плит - від 500 грн.</p>
                            <p class="SimpleInfoText">Ремонт системи нагрівання - від 380 грн.</p>
                            <p class="SimpleInfoText">Заміна ламп - від 120 грн.</p>
                            <p class="SimpleInfoText">Ремонт поверхні - від 450 грн.</p>
                            <p class="SimpleInfoText">Ремонт блоків живлення - від 320 грн.</p>
                            <p class="SimpleInfoText">Заміна системи конвертування - від 200 грн.</p>
                            <p class="SimpleInfoText">Заміна інвертора - від 430 грн.</p>
                            <p class="SimpleInfoText">Заміна кришки - від 500 грн.</p>
                            <p class="SimpleInfoText">Заміна згорілих запобіжників від 100 грн.</p>
                            <p class="SimpleInfoText">Заміна магнітів - від 350 грн.</p>
                            <p class="SimpleInfoText"> Ремонт/установка нових інтерфейсів - від 400 грн.</p>
                        </div>
                    </div>
                    <div class="InfoIntroText">
                ...
                <div class=ThirdInfoColumn>
                    <img class="FirstInfoImg" src="img/informationalcooker/plitarepair1.png" alt="FirstImage">
                    <img class="SecondInfoImg"src="img/informationalcooker/plitarepair2.png" alt="SecondImage">
                </div>
            </div>
        </div>
    </section>
