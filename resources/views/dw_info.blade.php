    ...
    <section class="FirstInfoPart">
        <div class="container">
            <div class="FirstInfoContent">
                <h1 class="MainHeadText">Ремонт посудомийних машин</h1>
                <div class="WrapDiv">
                    <div class="InfoButtonCont">
                        <img class="InfoBG" src="img/informationaldw/imgDW.jpg" alt="TVBackground">
                        <a href="#">
                    ...
                    <div class="InfoIntro">
                        <div class="InfoIntroText">
                            ...
                            <p class="SimpleInfoText">від 600 до 6000 грн;</p>
        ...
        <div class="container">
            ...
            <div class="ThirdInfoContent">
                <div class=ThirdInfoColumn>
                    <div class="InfoIntro">
                        <div class="InfoIntroText">
                            <p class="SimpleInfoText">Заміна датчиків - 300 грн.</p>
                            <p class="SimpleInfoText">Заміна тарілкотримачей - 600 грн.</p>
                            <p class="SimpleInfoText">Заміна електроклапану - 300 грн.</p>
                            <p class="SimpleInfoText">Заміна центрифуги - 1200 грн.</p>
                            <p class="SimpleInfoText">Заміна електронасосу - 300 грн.</p>
                            <p class="SimpleInfoText">Заміна компресору - 600 грн.</p>
                            <p class="SimpleInfoText">Заміна ручок, резинок, патрубків - 300 грн.</p>
                            <p class="SimpleInfoText">Заміна таблета - 750 грн.</p>
                            <p class="SimpleInfoText">Заміна головного насоса - 550 грн.</p>
                            <p class="SimpleInfoText">Ремонт головного зливу - 1550 грн.</p>
                            <p class="SimpleInfoText">Ремонт замків - 450 грн.</p>
                            <p class="SimpleInfoText">Ремонт тримачів - 650 грн.</p>
                            <p class="SimpleInfoText">Ремонт крюків - 250 грн.</p>
                            <p class="SimpleInfoText">Ремонт розріднювача - 1250 грн.</p>
                        </div>
                    </div>
                    <div class="InfoIntroText">
                ...
                <div class=ThirdInfoColumn>
                    <img class="FirstInfoImg" src="img/informationaldw/rep1.jpg" alt="FirstImage">
                    <img class="SecondInfoImg"src="img/informationaldw/rep2.jpg" alt="SecondImage">
                </div>
            </div>
        </div>
    </section>
