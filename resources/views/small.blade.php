    ...
    <section class="FirstInfoPart">
        <div class="container">
            <div class="FirstInfoContent">
                <h1 class="MainHeadText">Ремонт дрібної техніки</h1>
                <div class="WrapDiv">
                    <div class="InfoButtonCont">
                        <img class="InfoBG" src="img/informationalsmall/small.png" alt="SmallBackground">
                        <a href="#">
                    ...
                    <div class="InfoIntro">
                        <div class="InfoIntroText">
                            ...
                            <p class="SimpleInfoText">від 300 до 3000 грн;</p>
        ...
        <div class="container">
            ...
            <div class="ThirdInfoContent">
                <div class=ThirdInfoColumn>
                    <div class="InfoIntro">
                        <div class="InfoIntroText">
                            <p class="SimpleInfoText">Ремонт фенів - від 430 грн.</p>
                            <p class="SimpleInfoText">Заміна дисплею - від 430 грн.</p>
                            <p class="SimpleInfoText">Ремонт кухонних комбайнів - від 500 грн.</p>
                            <p class="SimpleInfoText">Ремонт систем кондицонування - від 380 грн.</p>
                            <p class="SimpleInfoText">Заміна ламп - від 120 грн.</p>
                            <p class="SimpleInfoText">Ремонт міксерів - від 450 грн.</p>
                            ...
                            <p class="SimpleInfoText">Заміна мотору - від 500 грн.</p>
                            <p class="SimpleInfoText">Заміна згорілих запобіжників від 100 грн.</p>
                            <p class="SimpleInfoText">Заміна дротів - від 350 грн.</p>
                            <p class="SimpleInfoText"> Ремонт/установка нових серцевин - від 400 грн.</p>
                        </div>
                    </div>
                    <div class="InfoIntroText">
                ...
                <div class=ThirdInfoColumn>
                    <img class="FirstInfoImg" src="img/informationalsmall/rep1.png" alt="FirstImage">
                    <img class="SecondInfoImg" src="img/informationalsmall/rep2.png" alt="SecondImage">
                </div>
            </div>
        </div>
    </section>
