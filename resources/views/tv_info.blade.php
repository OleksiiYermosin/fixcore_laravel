    ...
    <section class="FirstInfoPart">
        <div class="container">
            <div class="FirstInfoContent">
                <h1 class="MainHeadText">Ремонт телевізорів</h1>
                <div class="WrapDiv">
                    <div class="InfoButtonCont">
                        <img class="InfoBG" src="img/informationaltv/imgTV.png" alt="TVBackground">
                        <a href="#">
            ...
            <div class="SecondInfoContent">
                <div class="SecondInfoBox">
                    <div class="SecondInfoTextBox">
                        <p class="InfoOrangeText">Не працює телевізор?</p>
                        <p class="InfoSimpleText">
                            Ми здійснюємо ремонт телевізорів будь-якої
                            марки і року випуску: LCD, LED, плазмових
                            і т.д. Везти телевізор до сервісного центру
                            ...
                            телевізор, вам треба лише подати нам заявку на
        ...
        <div class="container">
            ...
            <div class="ThirdInfoContent">
                <div class=ThirdInfoColumn>
                    <div class="InfoIntro">
                        <div class="InfoIntroText">
                            <p class="SimpleInfoText">Заміна матриць - від 430 грн.</p>
                            <p class="SimpleInfoText">Заміна екранів - від 430 грн.</p>
                            <p class="SimpleInfoText">Ремонт сісітемних плат - від 500 грн.</p>
                            <p class="SimpleInfoText">Ремонт системи підсвічування - від 380 грн.</p>
                            <p class="SimpleInfoText">Заміна ламп - від 120 грн.</p>
                            <p class="SimpleInfoText">Ремонт тюнерів - від 450 грн.</p>
                            ...
                            <p class="SimpleInfoText">Заміна процесора - від 500 грн.</p>
                            <p class="SimpleInfoText">Заміна згорілих запобіжників від 100 грн.</p>
                            <p class="SimpleInfoText">Заміна шлейфів - від 350 грн.</p>
                            <p class="SimpleInfoText"> Ремонт/установка нових динаміків - від 400 грн.</p>
                        </div>
                    </div>
                    <div class="InfoIntroText">
                ...
                <div class=ThirdInfoColumn>
                    <img class="FirstInfoImg" src="img/informationaltv/img2.png" alt="FirstImage">
                    <img class="SecondInfoImg" src="img/informationaltv/img1.png" alt="SecondImage">
                </div>
            </div>
        </div>
    </section>
